...
/**
 * Tests that CleanAstBuilder produces correct ValueSpecification AST.
 * 
...
class CleanAstBuilderTest {
    ...
    class CollectionTests {
        ...
        void array() {
            var ast = parse("[1, 2, 3]");
            assertInstanceOf(Collection.class, ast);
            var coll = (Collection) ast;
